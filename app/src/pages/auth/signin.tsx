...
export default function SignIn({
    ...
    return (
        <>
            <div className="font-sans w-full h-screen flex bg-foreground text-white">
                <Image src="/login.jpg" alt='background' width={1920} height={1080} className="object-cover object-center h-screen w-7/12" />
                <div className="flex flex-col justify-center items-center w-5/12 shadow-lg">
                    ...
                    <div className="w-1/2 text-left mt-12">
                        ...
                        <div className="flex items-center justify-center flex-col gap-2">
                            ...
                            <Button
                                type="button"
                                className="text-white bg-white w-full font-medium rounded-none bg-[#050708] hover:bg-[#050708]/80 text-sm px-5 py-6 text-center inline-flex items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 me-2 mb-2">
                            ...
                            <p className="text-xs mt-24"> © Chess Tactics Manager 2024 </p>
                        </div>
                    </div>
                </div>
            </div>
