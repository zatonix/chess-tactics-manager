    ...
    return (
        <div className="flex flex-col min-w-20 w-20 justify-between items-center bg-foreground shadow-lg">
            ...
            <div className="flex flex-col items-center justify-around gap-12">
                <SidebarButton label='Home' baseUrl='/' icon={<LayoutDashboard />} active={activeMenu === 'home'} />
                <SidebarButton label='Stats' baseUrl='/stats' icon={<AreaChart />} active={activeMenu === 'stats'} />
                <SidebarButton label='Profile' baseUrl='/profile' icon={<UserCog />} active={activeMenu === 'profile'} />
            </div>
            <p></p>
        </div>
    )
